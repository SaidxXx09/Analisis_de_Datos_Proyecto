...
def limpiar_holidays():
    ...
    if os.path.exists(RUTA_REPORTE):
        with open(RUTA_REPORTE, 'r', encoding='utf-8') as f:
            reporte_limpieza_holidays = json.load(f)
    else:
        reporte_limpieza_holidays = {}


    reporte_limpieza_holidays['INFORMACION_HOLIDAYS'] = info_holidays_limpio
